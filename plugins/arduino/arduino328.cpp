...
LibraryItem* Arduino328Plugin::libraryItem()
{
    return new LibraryItem(
        ...
        "",
        tr("Arduino"),
        Arduino328::construct );
}

Component* Arduino328::construct( QObject* parent, QString type, QString id )
{ 
    if( m_canCreate ) return new Arduino328( parent, type,  id ); 
...
Arduino328::Arduino328( QObject* parent, QString type, QString id )
    : McuComponent( parent, type, id )
{
    qDebug() << "        Initializing Arduino328...";
    m_pSelf = this;
    ...
    qDebug() << "     ...Arduino328 OK\n";
}
Arduino328::~Arduino328() 
{
}

void Arduino328::remove()
{
...
void Arduino328::initBootloader()
{
...
void Arduino328::initBoard()
{
    ...
    for( int i=0; i<m_numpins; i++ )                      // Create Pins
    {
        ...
        else if( pinId.contains( "PB5" ) )                     // Pin 13 
        {
...
void Arduino328::attachPins()
{
    ...
    if (!m_uart_pty.run) //thread)
    {
        std::cout << "Arduino328::attachPins, Failed to run uart_pty" << std::endl;
    }*/
}

void Arduino328::addPin( QString id, QString type, QString label, int pos, int xpos, int ypos, int angle )
{
    //qDebug()<<pos<<id<<label;
...
void Arduino328::adcread( int channel )
{
...
void Arduino328::paint( QPainter *p, const QStyleOptionGraphicsItem *option, QWidget *widget )
{
