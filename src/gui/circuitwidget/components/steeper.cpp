...
{
    return new Steeper( parent, type, id );
}


LibraryItem* Steeper::libraryItem()
{
...
Steeper::Steeper( QObject* parent, QString type, QString id )
...
void Steeper::setSteps( int steps ) //" 4, 8,16,32"
{
    m_steps = steps/4;
    m_steps *= 4;
...
void Steeper::setRes( double res )
{
    m_res = res;
