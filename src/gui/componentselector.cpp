...
void ComponentSelector::slotUnistallItem()
{
    ...
    qDebug() << "plugins/"+m_lastItemClicked.toUpper()+"uninstall";
    
    QFile fIn( "plugins/"+m_lastItemClicked.toUpper()+"uninstall" );
...
void ComponentSelector::slotIstallItem()
{
    ...
    QString dir2 = dir;
    QFile fOut("plugins/"+dir2.remove("plugin").split("/").last().toUpper()+"uninstall");
