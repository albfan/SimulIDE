...
{
    m_avra      = m_appPath+"/tools/avra/avra";
...
int GcbDebugger::compileGcb( QString file )
{
    ...
    QString command = m_gcBasic + args + file;
    ...
    return error;
    //TODO: create fuction: CodeEditor::moveCursorTo( int line )
}
...
int GcbDebugger::compileAsm( QString file )
{
    ...
    {
        command = m_avra + " -W NoRegDef";              // supress some warnings
        command.append(" -l "+ m_fileName+".lst" );             // output list file
        command.append(" -I " + m_appPath + "/tools/avra ");    // include dir
